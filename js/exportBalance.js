    ...
    try {
        ...
        */
        ...
        const incomeEntries = cash.filter(
            entry => entry.type === 'ingreso'
        );

        const expenseEntries = cash.filter(
            entry => entry.type === 'egreso'
        );
        ...
        */
        ...
        /*
            Ganancia neta real del negocio:
        ...
        */
        ...
        const summaryRows = [
            ...
            [],
            ['Fecha de exportación', dateTimeText(new Date())],
            [],
            ['ORDENES'],
            ['Cantidad de órdenes', orders.length],
            ['Facturación total', moneyNumber(totalInvoiced)],
            ['Total cobrado en órdenes', moneyNumber(totalPaidFromOrders)],
            ['Total pendiente de cobro', moneyNumber(totalPending)],
            [],
            ['GASTOS'],
            ['Gastos asociados a órdenes', moneyNumber(totalOrderExpenses)],
            ['Gastos generales', moneyNumber(totalGeneralExpenses)],
            ['Gastos totales', moneyNumber(totalExpenses)],
            [],
            ['RESULTADOS'],
            ['Resultado de las órdenes', moneyNumber(totalOrderResult)],
            ['Ingresos de caja', moneyNumber(totalIncome)],
            ['Egresos de caja', moneyNumber(totalExpenses)],
            ['GANANCIA NETA', moneyNumber(netProfit)],
            [],
            ['Nota'],
            [
        ...
        cash.forEach(entry => {
            ...
            if (entry.type === 'ingreso') {
                ...
                if (entry.order_id) {
                    ...
                    week.orderExpenses += amount;

                } else {

                    week.generalExpenses += amount;
        ...
        [...weeks.values()]
            ...
            .forEach(week => {
                ...
                weeklyRows.push([
                    ...
                    `Semana ${getWeekNumber(week.start)}`,
        ...
        cash.forEach(entry => {
            ...
            if (entry.type === 'ingreso') {
                ...
                if (entry.order_id) {
                    ...
                    month.orderExpenses += amount;

                } else {

                    month.generalExpenses += amount;
